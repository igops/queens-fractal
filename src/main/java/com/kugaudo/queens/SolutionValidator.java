...
public class SolutionValidator {
    ...
    enum ValidationErrorType {
        ILLEGAL_QUEENS_COUNT, ILLEGAL_ROW_INDEX, ILLEGAL_COLUMN_INDEX, COLLISION_ROW, COLLISION_COLUMN, COLLISION_DIAGONAL_NORTH_EAST, COLLISION_DIAGONAL_NORTH_WEST;
    }
}
